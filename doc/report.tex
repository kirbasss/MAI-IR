...
В качестве тематики корпуса документов выбраны русскоязычные публикации о
компьютерных играх.

Кандидатами являются PlayGround.ru, StopGame.ru, IXBT.games и Игромания.
В окончательном корпусе будет не менее двух независимых источников. Файл
\code{urls.txt} содержит проверочную выборку из 15 страниц: 3 PlayGround, 5
...
Проверка проведена на 15 сохранённых HTML. В выборку вошли по 3 страницы
PlayGround и Игромании, 4 IXBT.games и 5 StopGame. В каждом документе найден
ровно один контейнер основного текста и выделено более 100 слов.
...
ссылаются на другие материалы и удаляются до извлечения.
...
Размер сырого HTML & 3,90 МБ \\
Размер выделенного текста & 257,3 КБ \\
Средний raw / text & 260,2 / 17,2 КБ \\
Медиана текста & 11,6 КБ \\
Минимум / максимум текста & 1,8 / 59,8 КБ \\
Слов всего & 20\,592 \\
...
\midrule
PlayGround & 3 & 0,64 & 34,1 & 11,4 & 2\,680 \\
StopGame & 5 & 1,25 & 103,7 & 20,7 & 8\,524 \\
IXBT.games & 4 & 1,24 & 59,5 & 14,9 & 4\,671 \\
Игромания & 3 & 0,77 & 60,1 & 20,0 & 4\,717 \\
\bottomrule
\end{tabular}
\end{center}
...
\caption{QR-код для перехода к исходному коду и отчёту в ветке \code{lab1}
репозитория.}
\end{figure}
...
четырёх сайтах и определил HTML-блоки, в которых находятся основной текст,
заголовок, дата и другие полезные метаданные. Для этих источников был написан
парсер, а результаты его работы сохранены в едином формате. Это позволило
получить небольшую, но пригодную для дальнейших экспериментов выборку
игрового корпуса.
...
В результате подготовлена воспроизводимая основа для продолжения работы:
сохранение исходного HTML, повторный разбор без сети, сбор статистики и
парсеры для четырёх независимых источников.
